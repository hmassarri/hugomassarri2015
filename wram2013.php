		...
		<div class="container">
			...
			<div id="projectContainerRow" class="row rowFix">
					   ...
					   <!-- Carousel items -->
					    <div class="carousel-inner">
					        <div class="active item">
					            <a href="http://www.hugomassarri.com/portfolio/wram2013/" target="_blank"><img src="images/wram.png" /></a>
				...
				<div id="projectDesc" class="col-md-4">
					...
					<p>&nbsp</p>
					<p><a href="http://www.hugomassarri.com/portfolio/wram2013/" target="_blank">/portfolio/wram2013</a></p>
				</div>
			</div>
